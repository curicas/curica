...
## Overview
The `Interactive Live Polling` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Real Time Communications. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Interactive Live Polling paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
