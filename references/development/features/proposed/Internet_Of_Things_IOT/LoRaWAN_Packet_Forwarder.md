...
## Overview
The `LoRaWAN Packet Forwarder` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Internet Of Things IOT. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with LoRaWAN Packet Forwarder paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
