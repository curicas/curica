...
## Overview
The `Edge Video Analytics` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Internet Of Things IOT. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Edge Video Analytics paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
