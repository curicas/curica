# Instruction Scheduling via CPU Topo

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Compiler Optimizations

## Overview
The `Instruction Scheduling via CPU Topo` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Compiler Optimizations. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Instruction Scheduling via CPU Topo paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
