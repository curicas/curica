# Industrial Arm Trajectory Planning
...
## Overview
The `Industrial Arm Trajectory Planning` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Robotics And Automation. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Industrial Arm Trajectory Planning paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
