# YOLOv8 Object Detection Native
...
## Overview
The `YOLOv8 Object Detection Native` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Computer Vision. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with YOLOv8 Object Detection Native paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
