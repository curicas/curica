# Zero-Shot Classification Built-in

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Agentic AI Integration

## Overview
The `Zero-Shot Classification Built-in` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Agentic AI Integration. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Zero-Shot Classification Built-in paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
