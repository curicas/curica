# Web3 Ethereum RPC Native Client
...
## Overview
The `Web3 Ethereum RPC Native Client` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Blockchain And Cryptography. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Web3 Ethereum RPC Native Client paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
