# DNS-over-HTTPS (DoH) Built-in Resolver

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Advanced Networking

## Overview
The `DNS-over-HTTPS (DoH) Built-in Resolver` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Advanced Networking. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with DNS-over-HTTPS (DoH) Built-in Resolver paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
