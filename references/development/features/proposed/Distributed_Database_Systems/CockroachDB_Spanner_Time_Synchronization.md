# CockroachDB/Spanner Time Synchronization

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Distributed Database Systems

## Overview
The `CockroachDB/Spanner Time Synchronization` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Distributed Database Systems. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with CockroachDB/Spanner Time Synchronization paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
