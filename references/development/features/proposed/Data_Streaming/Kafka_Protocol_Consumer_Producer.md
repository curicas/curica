# Kafka Protocol Consumer/Producer
...
## Overview
The `Kafka Protocol Consumer/Producer` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Data Streaming. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Kafka Protocol Consumer/Producer paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
