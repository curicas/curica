...
## Overview
The `Android JNI Java Native Interface` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Mobile App Framework. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Android JNI Java Native Interface paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
