# Biometric Authentication (Touch/FaceID)

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Mobile App Framework

## Overview
The `Biometric Authentication (Touch/FaceID)` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Mobile App Framework. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Biometric Authentication (Touch/FaceID) paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
