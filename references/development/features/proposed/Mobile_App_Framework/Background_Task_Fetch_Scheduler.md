# Background Task Fetch Scheduler
...
## Overview
The `Background Task Fetch Scheduler` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Mobile App Framework. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Background Task Fetch Scheduler paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
