# Box2D/Bullet Physics Engine Integration

**State**: Proposed
**Difficulty**: Advanced
**Domain**: Game Development Engine

## Overview
The `Box2D/Bullet Physics Engine Integration` is a proposed feature to vastly expand the capabilities of the Curica environment within the domain of Game Development Engine. 
...
## Expected Outcomes
Implementing this feature will allow developers to natively interact with Box2D/Bullet Physics Engine Integration paradigms using simple JavaScript APIs, completely eliminating the need for massive C++ node-gyp bindings or heavy external dependencies.
